...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { address: @church.address, mission: @church.mission, name: @church.name, vision: @church.vision } }
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { address: @church.address, mission: @church.mission, name: @church.name, vision: @church.vision } }
